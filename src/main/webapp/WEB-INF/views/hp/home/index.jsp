						...
						<div class="row justify-content-between align-items-center">
							...
							<div
								...
								<div class="hero__img" data-animation="bounceIn"
									data-delay=".4s">
									<img src="<c:url value='/img/hero/watch.png'/>" alt="" class=" heartbeat">
								</div>
							</div>
						</div>
					</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
						<div class="single-new-pro mb-30 text-center">
							<div class="product-img">
								<img src="<c:url value='/img/gallery/new_product1.png'/>" alt="">
							</div>
					...
					<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
						<div class="single-new-pro mb-30 text-center">
							<div class="product-img">
								<img src="<c:url value='/img/gallery/new_product2.png'/>" alt="">
							</div>
							<div class="product-caption">
								<h3>
									<a href="product_details.html">Thermo Ball Etip Gloves</a>
					...
					<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
						<div class="single-new-pro mb-30 text-center">
							<div class="product-img">
								<img src="<c:url value='/img/gallery/new_product3.png'/> " alt="">
							</div>
							<div class="product-caption">
								<h3>
									<a href="product_details.html">Thermo Ball Etip Gloves</a>
					...
					<div class="col-xl-6 col-lg-4 col-md-6 col-sm-6">
						<div class="single-gallery mb-30">
							<div class="gallery-img big-img"
								style="background-image: url(<c:url value='/img/gallery/gallery1.png'/>);"></div>
						</div>
					</div>
					<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
						<div class="single-gallery mb-30">
							<div class="gallery-img big-img"
								style="background-image: url(<c:url value='/img/gallery/gallery2.png'/>);"></div>
						</div>
					</div>
							...
							<div class="col-xl-12 col-lg-12 col-md-6 col-sm-6">
								<div class="single-gallery mb-30">
									<div class="gallery-img small-img"
										style="background-image: url(<c:url value='/img/gallery/gallery3.png'/>);"></div>
								</div>
							</div>
							<div class="col-xl-12 col-lg-12  col-md-6 col-sm-6">
								<div class="single-gallery mb-30">
									<div class="gallery-img small-img"
										style="background-image: url(<c:url value='/img/gallery/gallery4.png'/>);"></div>
								</div>
							</div>
						</div>
					</div>
